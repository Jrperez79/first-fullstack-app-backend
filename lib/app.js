...
app.post('/mls', async(req, res) => {
  ...
  INSERT INTO mls(name, conference, league_standing, ever_won_a_championship, owner_id)
  VALUES($1, $2, $3, $4, $5)
  RETURNING *
  `, [newMlsTeam.name, newMlsTeam.conference, newMlsTeam.league_standing, newMlsTeam.ever_won_a_championship, fakeUser.id]);

  res.json(data.row[0]);new
});
